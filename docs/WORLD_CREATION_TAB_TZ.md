...
- `open_questions`: вопросы, которые можно уточнить позже.
...
- выход архитектора: ответ для UI, обновленный world draft, model-history messages для хвостового append;
