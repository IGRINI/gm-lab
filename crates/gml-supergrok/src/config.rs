...
impl SuperGrokConfig {
    ...
    pub fn from_env() -> Self {
        ...
        set_string(&mut config.inference_base_url, "GM_SUPERGROK_BASE_URL");
        set_string(&mut config.model, "GM_SUPERGROK_MODEL");
        set_string(&mut config.compact_model, "GM_SUPERGROK_COMPACT_MODEL");
        set_string(
