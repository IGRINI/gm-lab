...
fn showcase_block() -> Vec<Value> {
    ...
    vec![
        ...
        json!({"kind": "gm_tool_call", "data": {"name": "generate_location", "arguments": {
            "purpose": "local_place",
            "request": "Игрок дошёл до таверны «Треснувший якорь», куда указала Лиза; создай зал, его реальные выходы и полный профиль входного перехода.",
            "target_place_id": "cracked_anchor_tavern",
            "commit": true,
